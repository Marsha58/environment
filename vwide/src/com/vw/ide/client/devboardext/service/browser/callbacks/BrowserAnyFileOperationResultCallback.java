...
public class BrowserAnyFileOperationResultCallback extends ResultCallback<RequestFileOperationResult> {

	private DevelopmentBoardPresenter owner = null;
	private HandlerOnFileOpertaion handler = null;

	public BrowserAnyFileOperationResultCallback(DevelopmentBoardPresenter owner, HandlerOnFileOpertaion handler) {
		this.owner = owner;
