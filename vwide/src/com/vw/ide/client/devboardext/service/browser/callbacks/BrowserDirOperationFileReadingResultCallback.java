...
public class BrowserDirOperationFileReadingResultCallback extends ResultCallback<RequestDirOperationResult> {

	private DevelopmentBoardPresenter owner = null;
	private HandlerOnDirOperation handler = null;
	
	public BrowserDirOperationFileReadingResultCallback(DevelopmentBoardPresenter owner, HandlerOnDirOperation handler) {
		this.owner = owner;
